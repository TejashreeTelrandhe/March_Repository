...
//		driver.findElement(By.cssSelector("input[name=\"uid\"]")).sendKeys("mngr472933");
		...
		boolean b1 = driver.findElement(By.xpath("//input[@name=\"sub\"]")).isDisplayed();
		soft.assertTrue(b1);
	...
	public void NewAccount() {
		...
		boolean b2 = driver.findElement(By.xpath("//input[@name=\"button\"]")).isEnabled();
		soft.assertTrue(b2);
	...
	public void EditCustomer() throws InterruptedException {
		...
		boolean b3 = driver.findElement(By.xpath("//input[@name=\"AccSubmit\"]")).isEnabled();
		soft.assertTrue(b3);
	...
	public void Deposit() {
		...
		boolean b4 = driver.findElement(By.xpath("//input[@name=\"AccSubmit\"]")).isEnabled();
		soft.assertTrue(b4);
