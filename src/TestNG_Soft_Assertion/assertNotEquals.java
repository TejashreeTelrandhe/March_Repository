...
//		driver.findElement(By.xpath("//input[@name=\"uid\"]")).sendKeys("mngr472933");
		...
		soft.assertNotEquals(title1, driver.getTitle());
...
//		String title2 ="Guru99 bank add new";
		soft.assertNotEquals(title2, driver.getTitle());
		System.out.println(driver.getTitle());
	...
	public void EditCustomer() throws InterruptedException {
		...
		soft.assertNotEquals(title3, driver.getTitle());
		System.out.println(driver.getTitle());
	...
	public void Deposit() {
		...
		soft.assertNotEquals(title4, driver.getTitle());
		System.out.println(driver.getTitle());
