...
import Com.internetbanking.Pageobject.InternetBanking_addcustomerpage;
...
public class NewCustomerTest extends BaseClass {
	...
	public void AddnewCustomer() throws InterruptedException, IOException {
		...
		InternetBanking_addcustomerpage Addcust = new InternetBanking_addcustomerpage();

		Addcust.ClickaddNewCustomer();
		logger.info("Click on addnew customer tab");
		...
		Addcust.CustAddress("snehahomes");
		...
		boolean Test = driver.findElement(By.xpath("//p[contains(text(),'Customer Registered Successfully!!!')]"))
				.isDisplayed();
